...
# Number of RNN units (number of neurons in the hidden layer)
rnn_units = 1024 


# Build the model with these layers:
# - Embedding layer maps each charater id into a vector 
# - GRU layer type of RNN
